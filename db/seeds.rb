...
Affinity.create("name": "Women")
Affinity.create("name": "Asian American")
Affinity.create("name": "Pacific Islander")
Affinity.create("name": "African American")
Affinity.create("name": "Indigenous People")
Affinity.create("name": "Disability/Accessibility")
Affinity.create("name": "Deaf Friendly")
Affinity.create("name": "Latino/Latina")
Affinity.create("name": "First Generation")
Affinity.create("name": "Undocumented")
Affinity.create("name": "Different Cultures/Subcultures")
Affinity.create("name": "Different/Sign Language")
Affinity.create("name": "Counterculture")
Affinity.create("name": "Muslim")
Affinity.create("name": "Jewish")
Affinity.create("name": "Buddhist")
Affinity.create("name": "Atheist")
Affinity.create("name": "Christian")
Affinity.create("name": "Hindu")
Affinity.create("name": "Other Religion")
